...
import { Orbit, Home, Map, Timer, Gem, Plane, Wrench, Coffee, Github } from "lucide-react";
...
const socialLinks = [
  { ref: "https://github.com/Feareis", color: "text-gray-400 hover:text-gray-500", ringColor: "focus:ring-green-500/50", icon: Github },
];
  ...
  return (
    <header className="w-full h-18 bg-[#181818] backdrop-blur-sm border-gray-700 shadow-md">
      <div className="container mx-auto px-6 py-0 h-full flex items-center justify-between">
        ...
        <Link
          to="/"
          className={`flex items-center gap-2 px-4 py-2 rounded-lg transition-all duration-200 text-gray-400`}
        >
          <Orbit size={26} />
        </Link>
